...
const paths = {
  source: config.server.paths.source,
  public: config.server.paths.public,
  pages: path.join(config.server.paths.source, config.server.paths.sourcePaths.pages),
  templates: path.join(config.server.paths.source, config.server.paths.sourcePaths.templates),
  styles: path.join(config.server.paths.source, config.server.paths.sourcePaths.styles),
  scripts: path.join(config.server.paths.source, config.server.paths.sourcePaths.scripts),
  assets: path.join(config.server.paths.source, config.server.paths.sourcePaths.assets),
};
